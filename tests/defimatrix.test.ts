// defimatrix.test.ts
import { DefiMatrix, DefiMatrixCore } from '../src/index';

describe('DefiMatrixCore', () => {
  let core: DefiMatrixCore;
  beforeEach(() => { core = new DefiMatrixCore(0.75); });
