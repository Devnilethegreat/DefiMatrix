# DefiMatrix: DeFi protocol interaction matrix with composability risk scoring Implementation
> Advanced typescript solution leveraging modern architecture patterns and cutting-edge AI technology.

DefiMatrix maps dependency relationships between DeFi protocols into a composability graph, scores systemic risk with a trained GNN, and highlights contagion paths ahead of liquidation cascades.

DefiMatrix's key benefits include:
...
```bash
git clone https://github.com/Devnilethegreat/DefiMatrix.git
cd DefiMatrix
```
...
- **2024-07-13** — Expand test coverage for edge cases
